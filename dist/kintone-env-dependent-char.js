...
// リモートリポジトリ
// https://github.com/takokke/kintone-yutaka-production-shipping-information
(function () {
  'use strict';
  ...
  kintone.events.on("app.record.detail.show", function (event) {
    try {
      ...
      // フィールド名を配列で定義
      var fieldCodes = ['ユタカ出し', '住所1', '住所2', '個人名_団体', '個人名_団体_フリガナ', '実納品時間', '希望納品時間', '担当者_名', '担当者_名_フリガナ', '担当者_姓', '担当者_姓_フリガナ', '注文者', '注文商品名', '納品書', '請求書', '都道府県', '配送業者', '領収書', '郵便番号1', '郵便番号2'];
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            return getAllRecordsResp.filter(function (record) {
              return nonJISRegex.test(record.ユタカ出し.value) || nonJISRegex.test(record.住所1.value) || nonJISRegex.test(record.住所2.value) || nonJISRegex.test(record.個人名_団体.value) || nonJISRegex.test(record.個人名_団体_フリガナ.value) || nonJISRegex.test(record.実納品時間.value) || nonJISRegex.test(record.希望納品時間.value) || nonJISRegex.test(record.担当者_名.value) || nonJISRegex.test(record.担当者_名_フリガナ.value) || nonJISRegex.test(record.担当者_姓.value) || nonJISRegex.test(record.担当者_姓_フリガナ.value) || nonJISRegex.test(record.注文商品名.value) || nonJISRegex.test(record.注文者.value) || nonJISRegex.test(record.納品書.value) || nonJISRegex.test(record.請求書.value) || nonJISRegex.test(record.郵便番号1.value) || nonJISRegex.test(record.郵便番号2.value) || nonJISRegex.test(record.都道府県.value) || nonJISRegex.test(record.配送業者.value) || nonJISRegex.test(record.領収書.value);
            });
          case 14:
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyutaka_production_shipping_infomation"] = self["webpackChunkyutaka_production_shipping_infomation"] || [];
